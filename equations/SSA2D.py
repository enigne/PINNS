...
class SSA2D_frictionNN(SSA2D): #{{{
    ...
    def __init__(self, hp, logger, X_f, 
        ...
        self.friction_model = create_NN(hp["friction_layers"], inputRange=(np.concatenate([ulb[0:1],ulb[1:2],ulb[4:5]]), np.concatenate([uub[0:1],uub[1:2],uub[4:5]])), outputRange=(fri_lb, fri_ub))
